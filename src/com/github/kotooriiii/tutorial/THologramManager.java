...
public class THologramManager {
    ...
    public void createDefaultHolograms() {
        ...
        createHologram(664f, 68f, 859.5f, "A player becomes a murderer when they kill 5 times.".split("\n")).getVisibilityManager().setVisibleByDefault(false);
        createHologram(664.5f, 68f, 757f, "A player becomes a criminal when they hit another player.".split("\n")).getVisibilityManager().setVisibleByDefault(false);
